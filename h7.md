...
Alkuun tehtävässä oli oman nimen yms tietojen laittoa, joten jätin nämä väliin. Kohda D:ssä oli asenna komento "hey" niin että kaikki voivat ajaa tätä, ja komennosta tulisi löytyä jotain tietoja. Tässäkin raportissa jo jotain tämän tyylistä tehtiin, mutta lähdin yrittämään pythonilla jotain uutta. Loin uuden tiedoston labratesti.py ja laitoin sinne sisään(stackoverflow. 2011):

<img width="498" height="173" alt="Näyttökuva 2025-10-04 kello 11 40 48" src="https://github.com/user-attachments/assets/9e2e9ccb-b892-41d3-98b7-ca06a6d6caf7" /> 
