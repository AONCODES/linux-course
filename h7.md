...
Tämän jälkeen oikeudet chmod a+x helloworld1.py ja koitin ajaa ohjelmaa ./helloworld1 -> toimii.
...
Seuraavaksi C ohjelma piti kääntää ja komennolla ./hello.cpp tuli näkyviin taas Hei maailma!
