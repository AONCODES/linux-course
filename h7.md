...
Valitsin ihan summamutikassa jonkun vain, ilman suurempaa tutkimista. Valinta oli Final Lab for Linux Palvelimet 2023 (Karvinen, 2023).

Alkuun tehtävässä oli oman nimen yms tietojen laittoa, joten jätin nämä väliin. Kohda D:ssä oli asenna komento "hey" niin että kaikki voivat ajaa tätä, ja komennosta tulisi löytyä jotain tietoja. Tässäkin raportissa jo jotain tämän tyylistä tehtiin, mutta lähdin yrittämään pythonilla jotain uutta. Loin uuden tiedoston labratesti.py ja laitoin sinne sisään:
<img width="498" height="173" alt="Näyttökuva 2025-10-04 kello 11 40 48" src="https://github.com/user-attachments/assets/9e2e9ccb-b892-41d3-98b7-ca06a6d6caf7" /> (stackoverflow. 2011)

Tämän jälkeen poistin tiedoston ja tein uuden nimellä "Hey" koska niinhän se tehtävänanto sanoi. Samat python koodit tiedostoon ja oikeudet chmod a+x hey. Sitten kopioin tiedoston (sudo cp ./hey /usr/local/bin/hey. Ja nyt ei taas tietoa onko tämä tehty oikein vai ei :D. mutta kun kirjoittaa Hey komentoriville tulee näkyviin: 

<img width="328" height="51" alt="Näyttökuva 2025-10-04 kello 11 50 05" src="https://github.com/user-attachments/assets/cd3d335c-68e4-491a-a97a-7b9dc2475e7e" />

Seuraavakohta oli asentaa microeditori, mutta se minula löytyikin jo niin skippasin tämänkin (vaikka tehtävän annossa oli aloittaa tyhjästä).

Tämän jälkeen huomasinkin, että lähes jokainen kohta on jokseenkin tuttu ja nämä olen jo tehnyt, eli olisi hyvä ollut aloittaa tyhjästä koneesta. Tehtävinä oli mm. uuden käyttäjän lisääminen sekä SSH-avaimien generoiminen keygen komennolla. Kohta H (Djangon lahjat) oli uusi kokomaan, mutta valitettavasti aika loppui, niin ei kerennyt perehtymään tarkemmin tuohon.

Tehdään sitten tuntilabrassa paremmin!
...
Karvinen, T. 2023. Final Lab for linux palvelimet 2023. Luettavissa: https://terokarvinen.com/2023/linux-palvelimet-2023-arvioitava-laboratorioharjoitus/?fromSearch=labo luettu: 4.10.2025

Stackoverflow. 2011. How can I use Python to get the system hostname? Luettavissa: https://stackoverflow.com/questions/4271740/how-can-i-use-python-to-get-the-system-hostname Luettu 4.10.2025
